...
function NewAnnouncementDialog({ open, onOpenChange }) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>{t('announcements.form.createTitle')}</DialogTitle>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-space-4">
          ...
          <DialogFooter>
            ...
            <Button type="submit" disabled={createAnnouncement.isPending}>
              {createAnnouncement.isPending ? t('common:states.loading', { ns: 'common' }) : t('announcements.form.publishButton')}
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>
...
function AnnouncementsPage() {
  ...
  return (
    <div className="space-y-space-4">
          ...
          <Card key={announcement.id}>
            <CardHeader className="flex flex-row items-start justify-between space-y-0">
              ...
              <div className="flex items-center gap-space-2">
                ...
                {canWrite && (
                  <Button variant="outline" size="sm" onClick={() => handleArchiveToggle(announcement)}>
      ...
      {canWrite && <NewAnnouncementDialog open={dialogOpen} onOpenChange={setDialogOpen} />}
    </div>
  );
}
