...
import StudentPortalAccountForm from '@/components/students/StudentPortalAccountForm';
...
function StudentDetailPage() {
  ...
  const canViewGrades = hasPermission('exams.read');
  ...
  return (
    <div className="space-y-space-6">
      ...
      {canViewGrades && <StudentGradesPanel studentId={student.id} />}
      ...
      <Card>
        ...
        <CardContent className="flex items-center justify-between gap-space-3">
          <p className="text-sm text-muted-foreground">
            {student.user_id ? t('portal.hasAccountDescription') : t('portal.noAccountDescription')}
          </p>
          {canWrite && !student.user_id && (
