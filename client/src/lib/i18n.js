...
i18n.use(initReactI18next).init({
  resources: {
    en: { common, auth, dashboard, students, guardians, attendance, admin, classes, teachers, exams },
  },
  lng: 'en',
  fallbackLng: 'en',
  ns: ['common', 'auth', 'dashboard', 'students', 'guardians', 'attendance', 'admin', 'classes', 'teachers', 'exams'],
  defaultNS: 'common',
  interpolation: {
